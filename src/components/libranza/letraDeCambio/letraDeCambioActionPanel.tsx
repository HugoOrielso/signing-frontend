...
export function LetraCambioActionPanel({
  mode,
  alreadySigned,
  showPad,
  setShowPad,
      ...
      <div className="relative p-3">
        ...
        {isViewMode || alreadySigned ? (
          <div className="flex items-center gap-4">
            <div className="flex h-11 w-11 items-center justify-center rounded-full bg-[#e8f5ee]">
            ...
            <div>
              ...
              <p className="mt-1 mb-0 text-[13px]">
                {isViewMode
                  ? "Este documento ya fue firmado y se muestra en modo solo lectura."
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="m-0 font-serif text-[19px] text-ink">
                    Firmar Letra de Cambio
                  </h2>
                  <p className="mt-0.75 mb-0 text-[13px]">
                    Firma este documento para continuar con el proceso.
                  </p>
                </div>
              </div>
